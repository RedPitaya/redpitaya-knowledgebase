...
After you have downloaded the `Red Pitaya Git repository <https://github.com/RedPitaya/RedPitaya.git>`_, move to the folder **RedPitaya/fpga/prj/Examples**. Open the **make_project.tcl** file and uncomment the line *"set project_name Led_blink"* and comment all other lines. Open Vivado and in Vivado Tcl Console navigate to the base folder: **RedPitaya/fpga/prj/Examples.** 
