...
.. image:: media/image1.03.png
   :name: Trigger Configuration first
...
.. image:: media/image1.08.png
   :name: Trigger configuration second
...
.. image:: media/image1.12.png
   :name: Configured for SAWU output OUT1

Fig. 11: OUT1 Configured for SAWU output

1. Capture a screenshot of the resulting waveforms. Comment on any visible similarities or differences.
...
.. image:: media/image1.13.png
   :name: Configured for SAWU output PWM
