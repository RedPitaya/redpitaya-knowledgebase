...
*The magnitude of the transfer function can be calculated by taking the absolute value of :math:T(f): The magnitude of the transfer function is given by :math:\left| T(f) \right| = \left| \frac{1}{1 + j2\pi fRC} \right|.*
